...
import 'package:fitness_club/Workout_Page/bicep_exercises/Sin2_page.dart';
import 'package:flutter/material.dart';

class in2_page extends StatefulWidget {
  const in2_page({super.key});

  @override
  State<in2_page> createState() => _in2_pageState();
}

class _in2_pageState extends State<in2_page> {
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () async {
                  _incrementCounter();
                  _incrementWorkout();
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Sin2_page(passedValue: "BICEPS"),));
