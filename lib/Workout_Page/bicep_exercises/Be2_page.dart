...
import 'package:fitness_club/Workout_Page/bicep_exercises/Sbe2_page.dart';
import 'package:flutter/material.dart';

class be2_page extends StatefulWidget {
  const be2_page({super.key});

  @override
  State<be2_page> createState() => _be2_pageState();
}

class _be2_pageState extends State<be2_page> {
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () async {
                  _incrementCounter();
                  _incrementWorkout();
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Sbe2_page(passedValue: "BICEPS"),));
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text('BICEP CURL DUMPBLE',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                Padding(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text('90 DEGREE DUMPBLE',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                Padding(
                                  padding: const EdgeInsets.only(right: 60),
                                  child: Text('x10',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.black45),),
                                ),
