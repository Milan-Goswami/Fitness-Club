...
import 'package:fitness_club/Workout_Page/Abs_exericises/Advanced_page.dart';
...
class Abs_page extends StatefulWidget {
  const Abs_page({super.key});

  @override
  State<Abs_page> createState() => _Abs_pageState();
}

class _Abs_pageState extends State<Abs_page> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Abs Exericises',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black45),),
      ),
                        ...
                        Column(
                          children: [
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Text('Build Abs',style: TextStyle(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: GestureDetector(
                                          onTap: (){
                                            Navigator.push(context, MaterialPageRoute(builder: (context) => Beginner_page(),));
                                          },
                                          child: Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: GestureDetector(
                                              onTap: (){
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => intermediate_page(),));
