...
import 'package:fitness_club/Workout_Page/triceps_exercises/Sbe6_page.dart';
import 'package:flutter/material.dart';

class Be6_page extends StatefulWidget {
  const Be6_page({super.key});

  @override
  State<Be6_page> createState() => _Be6_pageState();
}

class _Be6_pageState extends State<Be6_page> {
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () async {
                  _incrementCounter();
                  _incrementWorkout();
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Sbe6_page(passedValue: "TRICEPS"),));
