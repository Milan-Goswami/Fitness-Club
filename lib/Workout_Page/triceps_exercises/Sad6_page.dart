...
class Sad6_page extends StatefulWidget {
  final String passedValue;

  const Sad6_page({super.key, required this.passedValue});

  @override
  State<Sad6_page> createState() => _Sad6_pageState();
}

class _Sad6_pageState extends State<Sad6_page> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (CurrentIndex == content18.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content18[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Ad6_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
