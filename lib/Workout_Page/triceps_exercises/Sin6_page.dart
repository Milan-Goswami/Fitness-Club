...
class Sin6_page extends StatefulWidget {
  final String passedValue;

  const Sin6_page({super.key, required this.passedValue});

  @override
  State<Sin6_page> createState() => _Sin6_pageState();
}

class _Sin6_pageState extends State<Sin6_page> {
  ...
  Widget build(BuildContext context) {
    ...
    child:Scaffold(
      appBar: AppBar(
        ...
        title: Text('Intermediate',style: TextStyle( color: Colors.black45,fontWeight: FontWeight.bold),),
      ),
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (CurrentIndex == content17.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content17[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => in6_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
