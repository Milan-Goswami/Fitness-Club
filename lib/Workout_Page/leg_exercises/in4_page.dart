...
import 'package:fitness_club/Workout_Page/leg_exercises/Sin4_page.dart';
import 'package:flutter/material.dart';

class in4_page extends StatefulWidget {
  const in4_page({super.key});

  @override
  State<in4_page> createState() => _in4_pageState();
}

class _in4_pageState extends State<in4_page> {
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () async {
                  _incrementCounter();
                  _incrementWorkout();
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Sin4_page(passedValue: "LEG"),));
