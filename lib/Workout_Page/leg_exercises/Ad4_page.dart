...
import 'package:fitness_club/Workout_Page/leg_exercises/Sad4_page.dart';
import 'package:flutter/material.dart';

class Ad4_page extends StatefulWidget {
  const Ad4_page({super.key});

  @override
  State<Ad4_page> createState() => _Ad4_pageState();
}

class _Ad4_pageState extends State<Ad4_page> {
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () async {
                  _incrementCounter();
                  _incrementWorkout();
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Sad4_page(passedValue: "LEG"),));
