...
class Sad4_page extends StatefulWidget {
  final String passedValue;
  const Sad4_page({super.key, required this.passedValue});

  @override
  State<Sad4_page> createState() => _Sad4_pageState();
}

class _Sad4_pageState extends State<Sad4_page> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (CurrentIndex == content12.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content12[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Ad4_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
