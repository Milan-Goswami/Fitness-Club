...
class Sbe4_page extends StatefulWidget {
  final String passedValue;
  const Sbe4_page({super.key, required this.passedValue});

  @override
  State<Sbe4_page> createState() => _Sbe4_pageState();
}

class _Sbe4_pageState extends State<Sbe4_page> {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      if (CurrentIndex == content10.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content10[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Be4_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
