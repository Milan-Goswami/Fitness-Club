...
class Sin4_page extends StatefulWidget {
  final String passedValue;
  const Sin4_page({super.key, required this.passedValue});

  @override
  State<Sin4_page> createState() => _Sin4_pageState();
}

class _Sin4_pageState extends State<Sin4_page> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (CurrentIndex == content11.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content11[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => in4_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
