...
class Sbe_page extends StatefulWidget {
  final String passedValue;

  const Sbe_page({super.key, required this.passedValue});

  @override
  State<Sbe_page> createState() => _Sbe_pageState();
}

class _Sbe_pageState extends State<Sbe_page> {
  ...
  void _onNextExercise({bool isLast = false}) {
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const Beginner_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
