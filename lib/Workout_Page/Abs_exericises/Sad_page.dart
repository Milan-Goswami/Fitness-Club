...
class Sad_page extends StatefulWidget {
  final String passedValue;
  const Sad_page({super.key, required this.passedValue});

  @override
  State<Sad_page> createState() => _Sad_pageState();
}

class _Sad_pageState extends State<Sad_page> {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content3[CurrentIndex].title;
    double exerciseCals =
  ...
  Future<void> _storePartialWorkout() async {
    ...
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content1[CurrentIndex].title;
