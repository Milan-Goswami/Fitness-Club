...
import 'package:fitness_club/Workout_Page/Abs_exericises/startbe_page.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';

class Beginner_page extends StatefulWidget {
  const Beginner_page({super.key});

  @override
  State<Beginner_page> createState() => _Beginner_pageState();
}

class _Beginner_pageState extends State<Beginner_page> {
             ...
             Padding(
               ...
               child: GestureDetector(
                 onTap: () async {
                   _incrementCounter();
                   _incrementWorkout();
                   Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Sbe_page(passedValue: "ABS"),));
