...
class Sad3_page extends StatefulWidget {
  final String passedValue;
  const Sad3_page({super.key, required this.passedValue});

  @override
  State<Sad3_page> createState() => _Sad3_pageState();
}

class _Sad3_pageState extends State<Sad3_page> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (CurrentIndex == content9.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content9[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Ad3_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
