...
import 'package:fitness_club/Workout_Page/chest_exercises/Sad3_page.dart';
import 'package:flutter/material.dart';

class Ad3_page extends StatefulWidget {
  const Ad3_page({super.key});

  @override
  State<Ad3_page> createState() => _Ad3_pageState();
}

class _Ad3_pageState extends State<Ad3_page> {
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () async {
                  ...
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Sad3_page(passedValue: "CHEST"),));
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                     ...
                     // Text('120.0Kcal',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 20 ),)
                    ],
                  ),
                ),
