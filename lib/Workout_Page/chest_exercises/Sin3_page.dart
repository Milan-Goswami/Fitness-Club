...
class Sin3_page extends StatefulWidget {
  final String passedValue;
  const Sin3_page({super.key, required this.passedValue});

  @override
  State<Sin3_page> createState() => _Sin3_pageState();
}

class _Sin3_pageState extends State<Sin3_page> {
  ...
  final Map<String, double> exerciseMet = {
    ...
    "UPPER CHEST": 4.0,
    "DIAMOND PUSH UP": 6.5,
    "BENCH WITH DUMPBLE": 3.5,
    "LOWERCHEST DUMPBLE": 3.5,
    "DUMPBLE PRESS": 3.5,
  };
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (CurrentIndex == content8.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content8[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => in3_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
