...
String storedValue = "";
class Sbe3_page extends StatefulWidget {
  final String passedValue;
  const Sbe3_page({super.key, required this.passedValue});

  @override
  State<Sbe3_page> createState() => _Sbe3_pageState();
}

class _Sbe3_pageState extends State<Sbe3_page> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (CurrentIndex == content7.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content7[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Be3_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
