...
import 'package:fitness_club/Workout_Page/chest_exercises/Sin3_page.dart';
import 'package:flutter/material.dart';

class in3_page extends StatefulWidget {
  const in3_page({super.key});

  @override
  State<in3_page> createState() => _in3_pageState();
}

class _in3_pageState extends State<in3_page> {
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () async {
                  _incrementCounter();
                  _incrementWorkout();
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Sin3_page(passedValue: "CHEST"),));
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('            18 min',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 20 ),),
                   //   Text('112.0Kcal',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 20 ),)
                    ],
                  ),
                ),
