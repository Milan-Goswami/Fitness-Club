...
class Sad5_page extends StatefulWidget {
  final String passedValue;
  const Sad5_page({super.key, required this.passedValue});

  @override
  State<Sad5_page> createState() => _Sad5_pageState();
}

class _Sad5_pageState extends State<Sad5_page> {
  ...
  Widget build(BuildContext context) {
    ...
    child:Scaffold(
      appBar: AppBar(
        ...
        title: Text('Advanced',style: TextStyle( color: Colors.black45,fontWeight: FontWeight.bold),),
      ),
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (CurrentIndex == content15.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content15[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Ad5_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
