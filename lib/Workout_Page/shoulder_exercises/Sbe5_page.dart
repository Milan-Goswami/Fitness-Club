...
class Sbe5_page extends StatefulWidget {
  final String passedValue;
  const Sbe5_page({super.key, required this.passedValue});

  @override
  State<Sbe5_page> createState() => _Sbe5_pageState();
}

class _Sbe5_pageState extends State<Sbe5_page> {
// Approximate MET values for each exercise title
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (CurrentIndex == content13.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content13[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Be5_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
