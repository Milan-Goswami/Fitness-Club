...
class Sin5_page extends StatefulWidget {
  final String passedValue;
  const Sin5_page({super.key, required this.passedValue});

  @override
  State<Sin5_page> createState() => _Sin5_pageState();
}

class _Sin5_pageState extends State<Sin5_page> {
  ...
  final Map<String, double> exerciseMet = {
    "HAND RAISES": 3.0,
    "DUMPBLE SHOULDER": 3.5,
    "BENCH BAR PULL UP": 5.0,
    "BAR PULL UP": 6.0,
    "HIGH PULL": 4.0,
    "LATERAL RAISE": 3.0,
  };
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (CurrentIndex == content14.length - 1) {
  ...
  void _onNextExercise({bool isLast = false}) {
    int secondsSpent = _stopwatch.elapsed.inSeconds;
    final String currentExerciseName = content14[CurrentIndex].title;
    double exerciseCals =
    ...
    if (isLast) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => in5_page()),
      );
    } else {
      setState(() {
        CurrentIndex++;
